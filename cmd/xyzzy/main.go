...
var (
	...
	flagDebug     = flag.Bool("debug", false, "enable JaWS debug mode and lifecycle logging, allow two-player games, allow target score 1, and force the first black card to the highest-pick prompt")
)
